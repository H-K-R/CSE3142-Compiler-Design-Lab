...
int main()
{
    ...
    {
        cout << "(" << wordMap[palindromes[i]].first << "," << wordMap[palindromes[i]].second << ")" << palindromes[i] << endl;
    }
    cout << "\n"
         << endl;
    // Print Vowels
    ...
    {
        cout << "(" << wordMap[vowels[i]].first << "," << wordMap[vowels[i]].second << ")" << vowels[i] << endl;
    }
    ...
    {
        cout << "(" << wordMap[consonants[i]].first << "," << wordMap[consonants[i]].second << ")" << consonants[i] << endl;
    }
}